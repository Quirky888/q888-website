...
export const IMAGE_LICENSE_ACQUISITION_URL = `${SITE_URL}/copyright/#image-licensing`;

export const ARTIST_PROFILES = [
  "https://instagram.com/quirky_888",
  "https://www.linkedin.com/in/aleksander-sestakovs-a9068442/",
  "https://github.com/Quirky888",
  "https://apps.apple.com/us/app/digital-ink/id6757157376",
];

export const ARTIST_ID = `${SITE_URL}/#aleksandrs-sestakovs`;
